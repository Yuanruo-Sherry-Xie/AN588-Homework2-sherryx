...
x_range <- 0:30
poisson_mass_function <- dpois(x_values, exact)
...
ggplot(data = data.frame(x_range, poisson_mass_function), aes(x = x_values, y = poisson_mass_function)) +
...
-   The simulated data follows the PMF closely, with some small variations due to randomness of the 104 variables

    -   The histogram is therefore not symmetrical, bump on the left side
